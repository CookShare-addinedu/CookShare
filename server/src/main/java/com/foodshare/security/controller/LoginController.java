...
public class LoginController {
	...
	@PostMapping("/reissue")
	public ResponseEntity<?> reissueToken(@CookieValue(name = "Refresh-Token") String encodedRefreshToken,
		...
		try {
			...
			responseData.put("새로운 엑세스토큰유효기간(accessTokenExpiresIn)",
				dateFormat.format(new Date(accessTokenExpirationMs)));
			...
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
				.body("Token processing error: " + e.getMessage());
		}
	}
